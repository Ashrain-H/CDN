...
j.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, r, p) {
 if (p.get || p.set) {
  throw new TypeError("ES3 does not support.")
 }
...
function createCircle(e, t) {
 var a = {};
 return a.x = e, a.y = t, a.color = "#FF4500", a.radius = 0.1, a.alpha = 0.5, a.lineWidth = 8, a.draw = function() {
...
if (canvasEl) {
 var ctx = canvasEl.getContext("2d"),
  ...
  pointerY = 0,
  tap = "mousedown",
  colors = ["#FF8C00", "#FFFF00", "#ADFF2F", "#FF4500"],
